...
| 단계 | 설명 |
|------|------|
| [외부 정찰](lifecycle/reconnaissance.md) | OSINT, 포트 스캔, 서비스 식별, 디렉토리 열거 |
| [초기 침투](lifecycle/initial-access.md) | 피싱, Password Spray, 외부 서비스 취약점 |
| [내부 정찰 및 열거](lifecycle/enumeration.md) | SMB, LDAP, RPC, AD 환경 열거 |
| [자격 증명 탈취](lifecycle/credential-access.md) | Kerberoasting, AS-REP Roasting, DCSync, LLMNR Poisoning |
...
| [LDAP](protocols/ldap.md) | 389/636 | 디렉토리 서비스, AD 쿼리 |
| [HTTP](protocols/http.md) | 80/443 | 웹 서비스, 디렉토리/파라미터 열거 |
...
| [DNS](protocols/dns.md) | 53 | Zone Transfer, 서브도메인 열거 |
...
| 항목 | 설명 |
|------|------|
| [리버스 쉘](infra/shells.md) | 다양한 언어/환경별 쉘 페이로드 |

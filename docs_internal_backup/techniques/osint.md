...
!!! info "reconnaissance.md 와의 분담"
    ...
    - [외부 정찰 (Active)](../lifecycle/reconnaissance.md): Nmap, directory fuzzing, subdomain bruteforce 처럼 target에 직접 붙는 Active scan.
...
- [초기 침투](../lifecycle/initial-access.md)
- [외부 정찰 (Active)](../lifecycle/reconnaissance.md)
